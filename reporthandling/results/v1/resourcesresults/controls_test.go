...
func TestSetStatus(t *testing.T) {
	...
	assert.Equal(t, apis.StatusUnknown, r1.GetSubStatus().Status())
	...
	assert.Equal(t, apis.StatusUnknown, r2.GetSubStatus().Status())
	...
	assert.Equal(t, apis.SubStatusException, r3.GetSubStatus().Status())
	...
	assert.Equal(t, apis.SubStatusConfiguration, r4.GetSubStatus().Status())
	...
	assert.Equal(t, apis.SubStatusManualReview, r5.GetSubStatus().Status())
	...
	assert.Equal(t, apis.SubStatusRequiresReview, r6.GetSubStatus().Status())
